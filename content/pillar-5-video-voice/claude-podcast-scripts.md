---
title: "Writing Podcast Scripts with Claude AI (2026 Guide)"
slug: claude-podcast-scripts
pillar: video-voice
meta_description: "Write podcast scripts with Claude AI in 2026. Solo show templates, interview formats, show notes, intro/outro scripts, and how to voice your podcast with ElevenLabs."
primary_keyword: "Claude podcast scripts"
secondary_keywords:
  - "AI podcast script writer 2026"
  - "podcast show notes Claude AI"
  - "ElevenLabs podcast narration"
affiliates:
  - elevenlabs
date_published: "2026-06-07"
date_modified: "2026-06-07"
faq:
  - q: "Can Claude write podcast scripts?"
    a: "Yes. Claude writes complete podcast scripts for solo shows, co-hosted shows, and interview formats. It can produce a full episode script from a topic brief, develop talking points from research notes, write word-for-word narration for scripted podcasts, or produce a flexible outline for conversational shows. Claude also writes show notes, episode summaries, and social media copy from the same brief."
  - q: "How do I make a podcast script sound natural?"
    a: "Tell Claude the script is for audio and ask it to write in a spoken register. This means: contractions (you're, it's, we've), short sentences, direct address to a single listener ('you' rather than 'listeners'), and transitions that feel like speech ('So here's the thing...' not 'Furthermore...'). Always read the script aloud before recording — stiff phrasing is obvious when spoken."
...
1. **Cold open** (30–60 seconds): Drop in mid-thought or mid-story before the intro music
2. **Intro music + show intro** (15–30 seconds): Pre-recorded jingle + short host intro
3. **Episode intro** (60–90 seconds): What this episode covers and why it matters today
4. **Main content** (15–45 minutes depending on show length): 3–5 substantive sections with transitions
5. **Summary** (60–90 seconds): Recap the 3 key takeaways
6. **Outro + CTA** (45–60 seconds): Next episode preview, subscribe request, sponsor message
...
1. **Pre-intro teaser** (30–60 seconds): Host teases the best quote or insight from the interview
2. **Show intro music**
3. **Guest intro** (60–90 seconds): Host introduces the guest and why they matter to the audience now
4. **Warm-up question** (2–3 minutes): A non-threatening opener to establish rapport
5. **Core topic block 1** (5–10 minutes): First substantive theme
6. **Core topic block 2** (5–10 minutes): Second substantive theme
7. **Core topic block 3** (5–10 minutes): Third substantive theme or challenge/counterpoint
8. **Rapid-fire or lightning round** (optional, 3–5 minutes): Personality questions
9. **Guest CTA** (2 minutes): Where to find the guest, what they want listeners to do
10. **Host outro** (60–90 seconds): Takeaways, next episode, subscribe CTA
...
1. Write the episode script in Claude using the solo format above
2. Ask Claude to add pacing notation: "Add `...` for pauses, `[BREATH]` for breath marks, and emphasise key words in *italics* for stress guidance."
3. Paste the script into [ElevenLabs](https://elevenlabs.io)
4. Select a voice that matches the show's personality (use "Narration" or "Podcast" tagged voices)
5. Set Stability to 0.55–0.65 for natural variation across a long script
6. Generate the audio and review section by section
7. Export the final audio file and upload to your podcast host
