---
title: "How to Write YouTube Scripts with Claude AI (2026 Guide)"
slug: claude-youtube-scripts
pillar: video-voice
meta_description: "Write better YouTube scripts faster using Claude AI. This 2026 guide covers hooks, structure templates, short-form vs long-form, and prompts for viral scripts."
primary_keyword: "write YouTube scripts with Claude"
secondary_keywords:
  - "Claude AI YouTube script template"
  - "AI video script writing 2026"
...
faq:
  - q: "Can Claude write YouTube video scripts?"
    a: "Yes. Claude can write complete YouTube scripts from a brief or topic, including a hook, introduction, structured body sections, and a call to action. You can prompt Claude to match your existing channel voice, target a specific audience, and optimise for watch time by front-loading the most compelling content."
  - q: "How long should a YouTube script be?"
    a: "Script length depends on video length. A rough guide: 150 words per minute of spoken video. A 10-minute video needs roughly 1,500 words of script. Short-form videos (YouTube Shorts, under 60 seconds) need 100–150 words maximum. For long-form content (15–30 minutes), a full structured script of 2,500–4,500 words keeps delivery on track."
...
If you want to visualise your script before recording, or create an AI video version, the script Claude wrote doubles as a prompt brief for [Kling AI](/claude-kling-ai/). Claude can also convert each script section into a Kling video prompt:
...
If you want to produce your YouTube video without recording your own voice, combine the Claude script with [ElevenLabs](/claude-elevenlabs-voiceover-workflow/). The script Claude produces is already formatted for spoken delivery. Paste it directly into ElevenLabs, choose a voice that matches your channel's personality, and export the audio. Pair the audio with footage, screen recordings, or AI-generated video from Kling AI for a fully AI-produced video.

## Related Claude Guides

- [Claude + ElevenLabs Voiceover Workflow](/claude-elevenlabs-voiceover-workflow/)
- [How to Write Video Storyboards with Claude](/claude-video-storyboards/)
- [Claude + Kling AI — Text to Video Workflow](/claude-kling-ai/)
