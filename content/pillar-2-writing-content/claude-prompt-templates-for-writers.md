---
title: "Claude Prompt Templates for Writers — 20 Ready-to-Use Prompts (2026)"
slug: claude-prompt-templates-for-writers
pillar: writing-content
meta_description: "20 Claude prompt templates for writers in 2026. Blog posts, emails, social media, copywriting, and editing prompts — ready to copy, customise, and use now."
primary_keyword: "Claude prompt templates for writers"
secondary_keywords:
  - "Claude writing prompts"
  - "best Claude prompts for content"
  - "Claude prompts blog posts emails"
affiliates: []
date_published: "2026-06-07"
date_modified: "2026-06-07"
faq:
  - q: "What are the best Claude prompts for writing?"
    a: "The best Claude writing prompts are specific about four things: the format you need (blog post, email, LinkedIn post), the audience (who will read it), the goal (what the reader should do or understand), and the tone (how it should sound). Generic prompts return generic output — every element of specificity improves the result."
  - q: "How do I make Claude write in my style?"
    a: "Paste 3–5 examples of your existing writing into the prompt and ask Claude to match the voice, sentence rhythm, and vocabulary. Then describe your style in concrete terms: 'short sentences, direct, no hedging, occasional dry humour, no bullet-point lists'. The combination of examples plus description produces the most accurate style matching."
...
Angle: [your specific argument or hook — not just the topic]
Tone: [e.g. authoritative but conversational, like a knowledgeable expert talking to a peer]
Word count: [target]
...
Context: [paste approved outline]
Audience: [audience]
Tone: [tone]
Length: [X words]
Include: [any specific points, data, or examples]
Do not repeat information from these completed sections: [list previous H2s]
```
...
Primary keyword: "[keyword]" — include within the first 100 words
Angle: [your specific hook or argument]
...
Post title: [title]
Primary keyword: "[keyword]"
Core benefit or claim: [what the reader gets from the article]
...
Audience: [who they are — job, problem, awareness level]
Sequence goal: [e.g. welcome + soft sell / nurture to webinar / recover abandoned cart]
Sending schedule: [e.g. Day 0, 1, 3, 5, 7]
Tone: [tone]
...
Format:
Subject line: [under 50 characters ideally]
...
Audience: [description]
Email goal: [drive opens for X reason]
...
Topic: [topic]
My angle / insight: [your specific perspective]
Audience: [who follows you on LinkedIn]
Tone: [e.g. credible but human — not corporate]
...
My angle: [specific point of view]
Number of tweets: [7–12]

Tweet 1 (hook): bold claim, surprising fact, or counter-intuitive opener — stands alone without needing context
Tweets 2–[N-1]: one insight per tweet, each self-contained under 260 characters
Final tweet: key takeaway + CTA
...
Primary benefit (the headline promise): [what the reader gets]
Target audience: [describe with specifics]
Tone: [tone]

Output:
Headline: [under 10 words, benefit-led, include keyword if possible]
Subheadline: [one sentence expanding the headline promise]
Supporting paragraph: [30–50 words]
...
Audience problem: [specific pain point]
Agitation: [what makes this problem worse?]
Solution: [how your product solves it]
Character limit: [platform limit]
Tone: [tone]

For each variant, use a different agitation angle.
Label variants A, B, C and flag the strongest.
```
...
Goal: [what happens when they click]
Audience: [description]
...
Current tone: [describe — e.g. overly formal, slightly flat]
Target tone: [describe — e.g. direct, warm, confident — like a knowledgeable friend]
...
Based on these examples, write the following:
...
- [How to Write Blog Posts with Claude](/how-to-write-blog-posts-with-claude/) — Full blog workflow using Prompts 1–5
- [How to Write Email Sequences with Claude](/how-to-write-email-sequences-with-claude/) — Full email workflow using Prompts 8–10
- [Claude for Copywriting](/claude-for-copywriting/) — Landing pages and ads using Prompts 14–16
- [How to Match Your Brand Voice in Claude](/claude-brand-voice/) — System prompts and voice documents for consistent output
- [Advanced Prompt Engineering for Claude](/advanced-prompt-engineering-claude/) — Go beyond templates with advanced prompting techniques
